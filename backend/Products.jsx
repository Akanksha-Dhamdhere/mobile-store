...
export default function Products() {
  ...
  const handleRemoveFilter = (key, value) => {
    ...
    if (key === "price") {
      updatedFilters.price = { min: 0, max: 100000 };
      setPriceRange([0, 100000]);
  ...
  const PRODUCT_CATEGORIES = products.length
    ? getUnique(products, "category")
    : [];
  const PRODUCT_BRANDS = products.length
    ? getUnique(products, "brand")
    : [];
        ...
        <div className="flex gap-6">
          ...
          <main className="flex-1">
            <div className="flex justify-between items-center mb-6 bg-white p-4 rounded-lg shadow">
              <span className="text-gray-700"><strong>{filteredProducts.length}</strong> products</span>
              <select
                value={sortOption}
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4">
              {Array.isArray(filteredProducts) && filteredProducts.length > 0 ? (
                filteredProducts.map((product) => {
                  ...
                  const inWishlist = wishlist.some(w => w._id === (product._id || product.id));
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="relative overflow-hidden h-48 bg-gray-200">
                        ...
                        {/* Wishlist Button */}
                        <button
                          onClick={() => inWishlist ? handleRemoveFromWishlist(product._id) : handleAddToWishlist(product)}
                      ...
                      <div className="p-3">
                        ...
                        <div className="flex items-center gap-2">
                          <span className="text-sm font-bold text-gray-900">₹{product.offerPrice || product.price}</span>
                          {product.isOffer && (
                ...
                <div className="col-span-full text-center py-12">
                  <p className="text-gray-500 text-lg">No products found. Please check back later or try adjusting your filters.</p>
                </div>
              )}
            </div>
          </main>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <div className="flex gap-2">
                  ...
                  <button
                    onClick={() => navigate(`/productdetails/${quickViewProduct._id}`)}
