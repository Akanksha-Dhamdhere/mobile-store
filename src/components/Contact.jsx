    ...
    <section className="py-10 px-4 md:px-10 bg-gray-50">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row gap-8">
          ...
          {/* Right: Karmayogi Institute Location */}
          <div className="flex-1 relative rounded-lg overflow-hidden shadow-lg h-72 md:h-auto min-h-[400px]">
            {/* View on Google Maps Button */}
            <a
              href="https://www.google.com/maps/place/Karmayogi+Institute+of+Technology,+Shelve,+Pandharpur"
              target="_blank"
            ...
            {/* Map overlay: address + actions */}
            <div className="absolute bottom-4 left-4 z-10 bg-white p-3 rounded-md shadow-md text-sm max-w-xs">
              <div className="flex items-start gap-3">
                <img
                  src="https://images.unsplash.com/photo-1522708323590-d24dbb6b0267?auto=format&fit=crop&w=800&q=60"
                  alt="Karmayogi Institute building"
                  className="w-20 h-12 md:w-24 md:h-16 object-cover rounded-md hidden sm:block"
                />
                <div className="flex-1">
                  <div className="font-semibold text-gray-800">Karmayogi Institute of Technology</div>
                  <div className="text-gray-500 text-xs mb-2">Gat No. 124, 125, Post Shelve, Tal. Pandharpur, Maharashtra 413304</div>
                  <div className="flex gap-2">
                    ...
                    <a
                      href="https://www.google.com/maps/dir/?api=1&destination=Karmayogi+Institute+of+Technology,+Shelve,+Pandharpur"
                      target="_blank"
                      rel="noopener noreferrer"
            ...
            {/* Embedded Google Map */}
            <iframe
              title="Karmayogi Location"
              src="https://www.google.com/maps?q=Karmayogi+Institute+of+Technology+Shelve+Pandharpur&output=embed"
              width="100%"
              height="100%"
              style={{ border: 0 }}
              allowFullScreen=""
